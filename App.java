...
public class App 
{
    ...
    public static void main( String[] args ) throws IOException
    {
    	...
    	Collector.writeLine(writer, Arrays.asList("Cycle","ID", "Age", "Condition", "POM", "Survival"));
		...
		//int probabilityNewPatient = 41; // The probability of acquiring a new patient
		int totalCycles = 96; // Number of cycles to run simulation, 1 cycle is 15 minutes
		...
		for (int cycle = 0; cycle < totalCycles; cycle++)
        {
			...
			//int newPatient = 1 + (int)(Math.random() * (100-1+1));
